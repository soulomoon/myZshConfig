...
_rabbitmqadmin()
{
    ...
    case "${prev}" in
        list)
            COMPREPLY=( $(compgen -W 'vhosts connections parameters exchanges users policies consumers permissions nodes channels bindings queues' -- ${cur}) )
            return 0
            ;;
        show)
            ...
            ;;
        declare)
            COMPREPLY=( $(compgen -W 'policy parameter queue exchange permission binding vhost user' -- ${cur}) )
            return 0
            ;;
        delete)
            COMPREPLY=( $(compgen -W 'policy parameter queue exchange permission binding vhost user' -- ${cur}) )
        ...
        --username)
            ...
            ;;
        -f)
            COMPREPLY=( $(compgen -W "tsv long bash raw_json pretty_json kvp table"  -- ${cur}) )
            return 0
            ;;
        --format)
            COMPREPLY=( $(compgen -W "tsv long bash raw_json pretty_json kvp table"  -- ${cur}) )
